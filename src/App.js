...
export default class App extends Component {
  render() {
    return (
      <div className="w-full min-h-screen relative text-white px-2 py-5 flex gap-[20px] lg:flex-row flex-col items-start justify-center">
        <div className="absolute w-full h-full inset-0  bg-black bg-opacity-60 overlay z-[-1]" />
        {/* Đặt vé */}
        <div className="lg:w-[60%] h-[full] w-[100%] flex flex-col justify-center items-center gap-[10px] z-[10]">
        ...
        <div className="lg:w-[40%] h-full w-full flex flex-col justify-center items-center lg:gap-[40px] gap:[20px] z-[10] px-5 ">
